        ...
        <div class='box box-solid'>
            <div class="box-header">
                <div class="pull-right">
                    <button class="btn btn-flat btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Tambah User</button>
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('Akun/add')?>";
    } else {
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Akun/delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
